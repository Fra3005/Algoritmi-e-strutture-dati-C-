...
*/
    ...
    u=new Cella<int>;
    util_n_tree<int> conta;
    T1.insRadice(u);
    T1.scriviNodo(T1.radiceAlbero(),4);

    T1.insPrimoFiglio(T1.radiceAlbero());
    T1.scriviNodo(T1.primoFiglio(T1.radiceAlbero()),2);
    T1.insFratello(T1.primoFiglio(T1.radiceAlbero()));
    T1.scriviNodo(T1.succFratello(T1.primoFiglio(T1.radiceAlbero())),2);
    ...
    T1.insPrimoFiglio(u);
    T1.scriviNodo(T1.primoFiglio(u),1);
    T1.insFratello(T1.primoFiglio(u));
    T1.scriviNodo(T1.succFratello(T1.primoFiglio(u)),1);
    T1.insPrimoFiglio(T1.succFratello(T1.primoFiglio(T1.radiceAlbero())));
    T1.scriviNodo(T1.primoFiglio(T1.succFratello(T1.primoFiglio(T1.radiceAlbero()))),3);


   // cout<<endl<<endl<<T1.n_leaf(T1.radiceAlbero(), somma);

   //cout<<T1.numeroFigli(T1.radiceAlbero());
    //T1.figliPari(T1.radiceAlbero());
    //cout<<conta.n_leaf(T1);
    cout<<conta.n_level(T1, 1);
 ...
 *
    ...
    T1.stampaAlbero();
    cout<<endl<< T1.trovaElemento(T1.radiceAlbero(), 6);
...
*/
    ...
    int somma =0;
    T1.stampaAlbero();
    T1.foglieK(T1.radiceAlbero(), somma, 7);
    cout<<endl;
    T1.stampaAlbero();
*/
   // cout<<endl;

   // cout<<T1.profondita(T1.radiceAlbero());
   // cout<<T1.nodiKfigli(T1.radiceAlbero(), 1);
