...
template<class T>
int List_vector<T>::posizione(value_type a){
	int j;
...
/*
template <class T>
int List_vector <T>:: num_elements(position a, position b){
	int valore=0;
	int i=0;
...
template<class T>
void List_vector<T>::exchange(position p1, position p2){
	value_type a =elements_[p1];
	elements_[p1] = elements_[p2];
	elements_[p2] = a;
