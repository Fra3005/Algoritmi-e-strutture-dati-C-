...
/*
 * assegnamo l'ultimo elemento nella coda
 * dopo di che se l'elemento � piu piccolo del nodo padre fixiamo
 */
...
/*
 * il minimo � la radice, quindi copiamo l'ultimo inserito nella radice
 * e poi fixiamo se ci sono nodi figli piu piccoli dei padri
 */
